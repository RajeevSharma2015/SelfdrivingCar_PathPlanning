/***************************************
Purpose : 
  Calculate situational costs using logistics function. Cost functions defined for scenario's and aggregated. Scenario's 
  covered covered:
    1. nearest approach
    2. nearest approach to any vehicle
    3. nearest approach to any vehicle in a lane
    4. velocities for trajectoried calculation
    5. cost evalution - for time & trajectory difference
    6. collision, jerk cost calculation. Calculation of average jerk cost
    7. Accelaration and average accelaration cost calculation
    8. Exceed speed limit cost
